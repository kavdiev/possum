...
urlpatterns += patterns('possum.base.views.carte.categories',
    url(r'^carte/$', 'categories', name='home_categories'),
    url(r'^carte/print/$', 'categories_print', name='categories_print'),
    url(r'^carte/send/$', 'categories_send', name='categories_send'),
    url(r'^carte/categories/$', 'categories', name='categories'),
    url(r'^carte/categories/add/$', 'categories_add', name='categories_add'),
    url(r'^carte/categories/new/$', 'categories_new', name='categories_new'),
    url(r'^carte/categories/(?P<cat_id>\d+)/$', 'categories_view', name='categories_view'),
    url(r'^carte/categories/(?P<cat_id>\d+)/less/$', 'categories_less_priority', name='categories_less_priority'),
    url(r'^carte/categories/(?P<cat_id>\d+)/more/$', 'categories_more_priority', name='categories_more_priority'),
    url(r'^carte/categories/(?P<cat_id>\d+)/less-10/$', 'categories_less_priority', {'nb': 10}, name='categories_less_priority'),
    url(r'^carte/categories/(?P<cat_id>\d+)/more-10/$', 'categories_more_priority', {'nb': 10}, name='categories_more_priority'),
    url(r'^carte/categories/(?P<cat_id>\d+)/surtaxable/$', 'categories_surtaxable', name='categories_surtaxable'),
    url(r'^carte/categories/(?P<cat_id>\d+)/name/$', 'categories_name', name='categories_name'),
    url(r'^carte/categories/(?P<cat_id>\d+)/name/set/$', 'categories_set_name', name='categories_set_name'),
    url(r'^carte/categories/(?P<cat_id>\d+)/color/$', 'categories_color', name='categories_color'),
    url(r'^carte/categories/(?P<cat_id>\d+)/color/set/$', 'categories_set_color', name='categories_set_color'),
    url(r'^carte/categories/(?P<cat_id>\d+)/vat_onsite/$', 'categories_vat_onsite', name='categories_vat_onsite'),
    url(r'^carte/categories/(?P<cat_id>\d+)/vat_onsite/set/(?P<vat_id>\d+)/$', 'categories_set_vat_onsite', name='categories_set_vat_onsite'),
    url(r'^carte/categories/(?P<cat_id>\d+)/vat_takeaway/$', 'categories_vat_takeaway', name='categories_vat_takeaway'),
    url(r'^carte/categories/(?P<cat_id>\d+)/vat_takeaway/set/(?P<vat_id>\d+)/$', 'categories_set_vat_takeaway', name='categories_set_vat_takeaway'),
    url(r'^carte/categories/(?P<cat_id>\d+)/delete/$', 'categories_delete', name='categories_delete'),
    url(r'^carte/categories/(?P<cat_id>\d+)/disable_surtaxe/$', 'categories_disable_surtaxe', name='categories_disable_surtaxe'),
    url(r'^carte/categories/(?P<cat_id>\d+)/kitchen/$', 'categories_set_kitchen', name='categories_set_kitchen'),
)

urlpatterns += patterns('possum.base.views.carte',
    url(r'^carte/categories/(?P<cat_id>\d+)/product/new/$', 'products_new', name='products_new'),
    url(r'^carte/products/(?P<product_id>\d+)/$', 'products_view', name='products_view'),
    url(r'^carte/products/(?P<product_id>\d+)/change/$', 'products_change', name='products_change'),
    url(r'^carte/products/(?P<product_id>\d+)/category/$', 'products_category', name='products_category'),
    url(r'^carte/products/(?P<product_id>\d+)/categories_ok/select/$', 'products_select_categories_ok', name='products_select_categories_ok'),
    url(r'^carte/products/(?P<product_id>\d+)/categories_ok/(?P<cat_id>\d+)/add/$', 'products_add_categories_ok', name='products_add_categories_ok'),
    url(r'^carte/products/(?P<product_id>\d+)/categories_ok/(?P<cat_id>\d+)/del/$', 'products_del_categories_ok', name='products_del_categories_ok'),
    url(r'^carte/products/(?P<product_id>\d+)/produits_ok/select/$', 'products_select_produits_ok', name='products_select_produits_ok'),
    ...
    url(r'^carte/products/(?P<product_id>\d+)/category/(?P<cat_id>\d+)/set/$', 'products_set_category', name='products_set_category'),
    url(r'^carte/products/(?P<product_id>\d+)/enable/$', 'products_enable', name='products_enable'),
    url(r'^carte/products/(?P<product_id>\d+)/cooking/$', 'products_cooking', name='products_cooking'),
)

urlpatterns += patterns('possum.base.views.bill',
    url(r'^bills/$', 'factures', name='home_factures'),
    url(r'^bill/new/$', 'bill_new', name='bill_new'),
    url(r'^bill/(?P<bill_id>\d+)/table/select/$', 'table_select', name='table_select'),
    url(r'^bill/(?P<bill_id>\d+)/table/set/(?P<table_id>\d+)/$', 'table_set', name='table_set'),
    url(r'^bill/(?P<bill_id>\d+)/couverts/select/$', 'couverts_select', name='couverts_select'),
    url(r'^bill/(?P<bill_id>\d+)/couverts/set/(?P<number>\d+)/$', 'couverts_set', name='couverts_set'),
    url(r'^bill/(?P<bill_id>\d+)/category/select/$', 'category_select', name='category_select'),
    url(r'^bill/(?P<bill_id>\d+)/category/(?P<category_id>\d+)/$', 'category_select', name='category_select'),
    url(r'^bill/(?P<bill_id>\d+)/product/add/(?P<product_id>\d+)/$', 'product_add', name='product_add'),
    url(r'^bill/(?P<bill_id>\d+)/product/(?P<category_id>\d+)/select/$', 'product_select', name='product_select'),
    url(r'^bill/(?P<bill_id>\d+)/product/(?P<product_id>\d+)/made_with/$', 'product_select_made_with', name='product_select_made_with'),
    ...
    url(r'^bill/(?P<bill_id>\d+)/sold/(?P<sold_id>\d+)/view/$', 'sold_view', name='sold_view'),
